...
namespace SUVRPG
{
    public class MapUI
    {
        ...
        {
            WriteLine("You have : " + player.CurrentGold + " gold. Your hitpoints are : " + player.Health + "/" + player.MaxHealth + ". You have a +" + player.AttackDmg + " weapon and a +" + player.Armor + " armor,");
        }
